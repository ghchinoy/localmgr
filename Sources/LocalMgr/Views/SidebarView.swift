            ...
            Section(header: Text("API Gateway (Port \(String(gateway.port)))")) {
                HStack {
                    Circle()
                        ...
                        .accessibilityValue(gateway.isRunning ? "Online" : "Offline")
                ...
                ForEach(EngineType.allCases) { engine in
                    ...
                    HStack {
                        Circle()
                            ...
                            // (localmgr-b9v.10 / ACC-1)
                            .accessibilityLabel("\(engine.rawValue) readiness")
                            .accessibilityValue(st.isInstalled ? "Ready" : "Missing")
